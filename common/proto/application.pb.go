...
func (x *MRResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MRResult) ProtoMessage() {}

func (x *MRResult) ProtoReflect() protoreflect.Message {
	mi := &file_application_proto_msgTypes[0]
...
// Deprecated: Use MRResult.ProtoReflect.Descriptor instead.
func (*MRResult) Descriptor() ([]byte, []int) {
	return file_application_proto_rawDescGZIP(), []int{0}
}

func (x *MRResult) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
type MREmpty struct {
	...
	RpcRes []string `protobuf:"bytes,1,rep,name=rpcRes,proto3" json:"rpcRes,omitempty"`
}

func (x *MREmpty) Reset() {
	*x = MREmpty{}
	if protoimpl.UnsafeEnabled {
...
func (x *MREmpty) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MREmpty) ProtoMessage() {}

func (x *MREmpty) ProtoReflect() protoreflect.Message {
	mi := &file_application_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MREmpty.ProtoReflect.Descriptor instead.
func (*MREmpty) Descriptor() ([]byte, []int) {
	return file_application_proto_rawDescGZIP(), []int{1}
}

func (x *MREmpty) GetRpcRes() []string {
	if x != nil {
		return x.RpcRes
	}
	return nil
...
var file_application_proto_rawDesc = []byte{
	...
	,
...
var file_application_proto_goTypes = []interface{}{
	(*MRResult)(nil), // 0: MRResult
	(*MREmpty)(nil),  // 1: MREmpty
}
var file_application_proto_depIdxs = []int32{
	0, // 0: APP.MapReduceResult:input_type -> MRResult
	1, // 1: APP.MapReduceResult:output_type -> MREmpty
